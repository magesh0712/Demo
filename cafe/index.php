...
<body class="bodyStyle">
	...
	<div id="mainContent">
		...
		<div id="mainPictures" class="center">
			...
			<hr>
			<p>Our caf&eacute; offer an assortment of delicious and delectable pastries and coffees that will put a smile on your face. From cookies to croissants, tarts and cakes, each treat is especially prepared to excite your tastebuds and brighten your day!</p>
			<br>
			<table>
				<tr>
					<td bgcolor="aquamarine">
						<div class="cursiveText">Magesh23 bakes a rich variety of cookies. Try them all!</div>
						<table>
							<tr>
		...
		<div>
			...
			<table>
				<tr>
					...
					<td><p>Magesh and Martha have been adding sweetness to their customers' lives since 2020.  Frank's recipes have been passed down from his mother and use simple and fresh ingredients to produce delightful flavors.  Both of them will personally greet you with a welcoming smile when you visit!</p></td>
				</tr>
			</table>
			<hr>
		</div>
